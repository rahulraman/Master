...
- (void)commonSetup
{
    _defaultFont = [UIFont fontWithName:@"SourceCodePro-Regular" size:14.0f];
    _boldFont = [UIFont fontWithName:@"SourceCodePro-Regular" size:14.0f];
    _italicFont = [UIFont fontWithName:@"SourceCodePro-Regular" size:14.0f];
    ...
    if (_italicFont == nil && ([UIFontDescriptor class] != nil))
    {
        ...
        _italicFont = (__bridge_transfer UIFont*)CTFontCreateWithName(CFSTR("SourceCodePro-Medium"), 14.0f, NULL);
    }
...
- (NSArray *)solverTokens
{
    NSArray *solverTokens =  @[
                               ...
                               [CYRToken tokenWithName:@"operator"
                                                expression:@"[/\\*,\\;:=<>\\+\\-\\^!Ჳ]"
                                                attributes:@{
                                                             NSForegroundColorAttributeName : RGB(48, 77, 251)
                                                             }],
                               ...
                               [CYRToken tokenWithName:@"reserved_words"
                                                expression:@"(acos|acosh|asin|asinh|atan|atanh|atomicweight|ceil|complex|cos|cosh|crandom|deriv|erf|erfc|exp|eye|floor|frac|gamma|gaussel|getconst|img|inf|integ|integhq|inv|ln|log10|log2|machineprecision|max|maximize|min|minimize|molecularweight|ncum|ones|pi|plot|random|real|round|sgn|sin|sqr|sinh|sqrt|tan|tanh|transpose|trunc|var|zeros|header|head|title|script |link|a href|body|section|div|footer|class|span|meta|bgcolor|admin|background|/script|noscript|h1|h2|h3|h4|h5|h6|a class|nav|<li>|<ul>|article class|/article|/a|<article|<a|html|<p>|</p>)"
                                                attributes:@{
                                                             NSForegroundColorAttributeName : RGB(182, 24, 13),
                                                             NSFontAttributeName : self.boldFont
                                                             }],
                               [CYRToken tokenWithName:@"chart_parameters"
                                                expression:@"(chartheight|charttitle|chartwidth|color|seriesname|showlegend|showxmajorgrid|showxminorgrid|showymajorgrid|showyminorgrid|transparency|thickness|xautoscale|xaxisrange|xlabel|xlogscale|xrange|yautoscale|yaxisrange|ylabel|ylogscale|yrange|src|href|id|td|br|hr|doctype|http|equiv|content|name|rel|class|!DOCTYPE HTML)"
                                                attributes:@{
                                                             NSForegroundColorAttributeName : RGB(15, 160, 0),
                                                             }],
